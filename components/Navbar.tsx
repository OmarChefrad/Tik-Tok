      ...
      <div className="md:pt-5">
        {userProfile ? (
          <div className="flex gap-5 h-12 md:gap-10">
            <Link href="/upload">
              <button className="rounded-lg h-24 px-2 md:px-4 text-md font-semibold flex items-center md:mt-3 md:h-8 shadow-md shadow-slate-300 md:shadow-md md:shadow-slate-300 hover:bg-black hover:text-white">
